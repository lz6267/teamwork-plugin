...
| 层级 | 覆盖目标 | 工具示例 | 要求 |
|------|----------|----------|------|
| **单元测试** | 工具函数、Hooks、纯逻辑 | Jest, Vitest | 覆盖率 > 70% |
| **组件测试** | UI 组件渲染、交互 | Testing Library | 核心组件必须覆盖 |
| **E2E 测试** | 关键用户流程 | Playwright, Cypress | P0 流程必须覆盖 |
...
## 环境信息
- 环境: Dev
- API Base: http://dev-api.example.com
- 数据库: dev_db@10.0.0.1
